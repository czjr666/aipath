...
export const META = {
  zh: {
    ...
    description:
      "零基础 AI 课程：用可视化与交互演示讲透 AI 核心原理，7 个阶段 37 课，从神经网络直觉到亲手构建 AI 应用，专为中文学习者设计。",
  ...
  en: {
    lang: "en",
    brand: "AI Essentials",
    title: "Interactive AI General Education Course — 37 Lessons, Zero Math",
    description:
      "A from-zero AI course: core principles explained through visuals and interactive demos. 7 stages, 37 lessons — from neural-network intuition to building your own AI apps.",
...
export const UI = {
  ...
  en: {
    ...
    pager: {
      ...
      tocBackDir: "← Contents",
      tocFwdDir: "Contents →",
      pathName: "Learning Path · 7 stages, 37 lessons",
      backToPath: "Back to the path",
    },
    lessonNav: {
      openAria: "Open contents",
      fab: "Contents",
      headTitle: "Contents · 37 lessons",
      shortcutHint: "Command+B",
      collapseAria: "Collapse contents",
      expandAria: "Expand contents",
    ...
    home: {
      ...
      pathEyebrow: "Learning Path",
      pathH2: "Learning Path · 7 Stages, 37 Lessons",
      pathSub:
