...
const C = {
  zh: {
    venn: {
      ...
      rings: {
        ...
        ml: { name: '机器学习 ML', sub: '1980s · 从数据中学规则' },
    ...
    goals: [
      ...
      '记住三个关键年份：1956、1980s、2012 —— 三个圈各自的起点',
    ],
    conceptTitle: '💡 核心概念：三个套娃般的圈',
    conceptLead:
      '人工智能是最大的圈（一个梦想），机器学习是其中一个圈（一条路线），深度学习是更小的圈（一种方法）。今天所有刷屏的 AI —— ChatGPT、Midjourney、自动驾驶 —— 几乎都住在最里面那个小圈里。点击下图的每一环看看。',
    threeTitle: '📖 三个圈，三句话',
    threeLead: '把它们各自最关键的一句话记住，这一课就值回票价了。',
    useCards: [
      {
        label: '最外圈 · 1956 年起',
        term: <>人工智能 <b>AI</b></>,
        body: <>让机器表现出智能的<b>一切</b>努力 —— 包括手写规则的老方法。早年的专家系统、下棋程序都算 AI，但它们不会“学习”。</>,
      },
      {
        label: '中间圈 · 1980s 兴起',
        term: <>机器学习 <b>ML</b></>,
        body: <>不再由人写规则，而是让机器<b>从数据里自己找规律</b>。垃圾邮件过滤、推荐系统是它的经典代表作。</>,
      },
      {
        label: '最内圈 · 2012 年爆发',
        term: <>深度学习 <b>DL</b></>,
        body: <>用<b>多层神经网络</b>做机器学习。人脸识别、AlphaGo、ChatGPT —— 这一轮 AI 浪潮的主角全在这里。</>,
      },
    ],
    handsTitle: '🎛️ 动手分一分',
    handsLead:
    ...
    pitfalls: [
      {
        ...
        why: <><b>病因：</b>科幻电影的视觉印象。实际上 AI 绝大多数时候只是服务器里运行的程序，而很多机器人（如流水线机械臂）只执行固定动作，并没有 AI。</>,
      },
      {
        bad: '深度学习这么火，其他机器学习方法都过时了',
        good: '在表格类数据上，梯度提升树等经典方法至今常常胜过神经网络',
        why: <><b>病因：</b>新闻只报道深度学习的突破。工业界的风控、定价、销量预测大量使用经典机器学习 —— 方法没有高低，只有合不合适。</>,
      },
      {
        bad: 'ChatGPT 这么聪明，说明通用人工智能（AGI）已经实现了',
        good: '目前所有落地的 AI 都是“专用 AI”，AGI 何时到来仍是开放问题',
        why: <><b>病因：</b>把“对话流畅”等同于“全面智能”。大模型在很多任务上仍会出错和“幻觉”（第 29 课细讲），离稳定可靠的通用智能还有距离 —— 距离多远，专家们也在激烈争论。</>,
      },
    ],
    quizTitle: '✍️ 小练习',
    quiz: [
      {
        ...
        a: <><b>都是。</b>深度学习 ⊂ 机器学习 ⊂ 人工智能，小圈必然属于大圈。但反过来不成立：深蓝是 AI，却不是机器学习。</>,
      },
      {
        q: '2. 朋友的创业产品宣称“搭载 AI 技术”。你想判断它是真有学习能力还是营销话术，该问什么？',
        a: <>问一句：<b>“它从什么数据里学习？数据变多它会变好吗？”</b>如果答案是“规则是我们配置好的”，那它只是普通程序 + 营销词；如果它确实随数据迭代变强，才是机器学习。</>,
      },
      {
        q: '3. 把三个年份和事件连起来：1956 / 1980s / 2012 —— 深度学习爆发、AI 概念诞生、机器学习兴起。',
        a: <><b>1956</b> 达特茅斯会议提出“人工智能”一词 → <b>1980s</b> 机器学习作为独立路线兴起 → <b>2012</b> AlexNet 在图像识别竞赛中碾压对手，深度学习时代开启。</>,
      },
    ],
  },
  ...
  en: {
    venn: {
      ...
      svgAria: 'Three nested circles: AI contains machine learning, which contains deep learning',
      rings: {
    ...
    threeLead: 'Memorize the single most important sentence for each, and this lesson has already paid for itself.',
    useCards: [
      {
        label: 'Outer circle · since 1956',
        term: <>Artificial Intelligence <b>AI</b></>,
        body: <>Every <b>effort</b> to make machines act intelligently — including the old rule-writing approach. Early expert systems and chess programs all count as AI, but they don’t “learn.”</>,
      },
      {
        label: 'Middle circle · rose in the 1980s',
        term: <>Machine Learning <b>ML</b></>,
        body: <>No longer humans writing rules, but machines <b>finding patterns in data themselves</b>. Spam filtering and recommender systems are its classic showcases.</>,
      },
      {
        label: 'Inner circle · exploded in 2012',
        term: <>Deep Learning <b>DL</b></>,
        body: <>Doing machine learning with <b>many-layered neural networks</b>. Face recognition, AlphaGo, ChatGPT — the stars of this AI wave are all here.</>,
      },
    ],
    ...
    flips: [
      { q: '“Deep Blue,” which beat the world chess champion in 1997', pill: { type: 'sky', text: 'Outer circle · classic AI' },
      ...
      { q: 'Your email’s spam filter', pill: { type: 'amber', text: 'Middle circle · machine learning' },
        why: 'It learns patterns from huge numbers of “spam / not spam” samples — a textbook case of classic machine learning.' },
      { q: 'ChatGPT', pill: { type: 'sage', text: 'Inner circle · deep learning' },
      ...
      { q: 'Your phone’s photo app auto-sorting by face', pill: { type: 'sage', text: 'Inner circle · deep learning' },
      ...
      { q: 'A “smart” AC that cools automatically above 26°C', pill: { type: 'ink', text: 'Outside · hard-coded rules' },
        why: 'Just one if-else, no learning at all. Marketing’s “smart” and technical AI are often not the same thing.' },
      { q: 'A shopping site’s “picks for you”', pill: { type: 'amber', text: 'Middle circle · machine learning' },
    ...
    pitfalls: [
      {
        ...
        why: <><b>Cause:</b> the visual impression from sci-fi movies. In reality AI is most often just a program running on a server, while many robots (like assembly-line arms) only perform fixed motions and contain no AI.</>,
      },
      {
        ...
        why: <><b>Cause:</b> the news only reports deep-learning breakthroughs. Industry uses classic machine learning heavily for risk control, pricing, and sales forecasting — no method is superior, only more or less suitable.</>,
      },
      {
        ...
        why: <><b>Cause:</b> equating “fluent conversation” with “all-round intelligence.” Large models still make mistakes and “hallucinate” on many tasks (detailed in Lesson 29), and remain a way off from stable, reliable general intelligence — exactly how far is something experts still hotly debate.</>,
      },
    ],
    ...
    quiz: [
      {
        ...
        a: <><b>Both true.</b> Deep learning ⊂ machine learning ⊂ AI; a smaller circle necessarily belongs to the larger one. But not the reverse: Deep Blue is AI, yet not machine learning.</>,
      },
      {
        ...
        a: <>Ask one thing: <b>“What data does it learn from? Does it get better as the data grows?”</b> If the answer is “we configured the rules,” it’s just an ordinary program plus a buzzword; only if it genuinely improves as data accumulates is it machine learning.</>,
      },
      {
        ...
        a: <><b>1956</b> the Dartmouth workshop coins the term “artificial intelligence” → <b>1980s</b> machine learning rises as an independent route → <b>2012</b> AlexNet crushes the competition in an image-recognition contest, opening the deep-learning era.</>,
      },
    ],
  },
}
...
function VennDemo({ c }) {
  ...
  const stage = (
    ...
    >
      <g className={ringClass('ai')} onClick={() => setKey('ai')}>
        ...
        <text x="200" y="62" textAnchor="middle" fontSize="15" fill="var(--fg-0)">{c.rings.ai.name}</text>
        <text className="sub" x="200" y="80" textAnchor="middle" fill="var(--fg-1)">{c.rings.ai.sub}</text>
      </g>
      <g className={ringClass('ml')} onClick={() => setKey('ml')}>
        ...
        <text x="200" y="152" textAnchor="middle" fontSize="14" fill="var(--fg-0)">{c.rings.ml.name}</text>
        <text className="sub" x="200" y="169" textAnchor="middle" fill="var(--fg-1)">{c.rings.ml.sub}</text>
      </g>
      <g className={ringClass('dl')} onClick={() => setKey('dl')}>
        ...
        <text x="200" y="282" textAnchor="middle" fontSize="13" fill="var(--fg-0)">{c.rings.dl.name}</text>
        <text className="sub" x="200" y="299" textAnchor="middle" fill="var(--fg-1)">{c.rings.dl.sub}</text>
      </g>
    </svg>
  )
  ...
  return <DemoPanel title={c.panelTitle} hint={c.panelHint} stage={stage} side={side} />
}
